...
dataset_links = {
    'train': {
        ...
        'annotations': os.path.join(dataset_base_path, 'train', 'ground_truths'),
        # folder where I3D features are stored
        'images': os.path.join(dataset_base_path, 'train', 'i3d_features'),
