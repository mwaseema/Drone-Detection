...
from train.temporal.config import dataset_links, n_classes, epochs, batch_size, steps_per_epoch, is_finetune, \
    old_weight_path
...
def main():
    ...
    model = keras_segmentation.models.pspnet.i3d_pspnet(n_classes=n_classes)
